...
namespace user_management.core.Shared
{
    public static class ApplicationConstants
    {
        ...
        public static string LockAddedMsg = $"<p> Dear Name, a new lock has been added to your account. Lock Id LockId. <a href='https://www.my-clay.com/'>Click here to read more about us</a></p>";
        public static string RoleAssignmentMsg = $"<p> Dear Name, a new role(roleName) has been added to your account. <a href='https://www.my-clay.com/'>Click here to read more about us</a></p>";
    }
}
